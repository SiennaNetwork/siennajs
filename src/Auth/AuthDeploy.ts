...
import { Versioned } from '../Versions'
import { SiennaConsole } from '../Console'
import type { Version } from './AuthConfig'
import { AuthProvider } from './AuthProvider'

export class AuthDeployment extends Versioned<Version> {
...
export class AuthProviderDeployment extends Versioned<Version> {

  log = new SiennaConsole(`Auth ${this.version}`)

  provider = this.defineContract({
    client:  AuthProvider,
    crate:   'auth-provider',
